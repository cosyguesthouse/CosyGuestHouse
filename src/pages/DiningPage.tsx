    ...
    return (
        ...
        >
            ...
            <div className="p-6 flex flex-col flex-grow">
                <h3 className="font-heading text-2xl font-light mb-2"><Translate text={item.title} /></h3>
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <div className="relative h-[70vh] overflow-hidden">
                ...
                >
                    <p className="font-body text-xs tracking-[0.4em] uppercase text-warm-gold mb-4">{t('dining.subtitle', 'Culinary')}</p>
                    <h1 className="font-heading text-5xl md:text-7xl font-light text-primary-foreground mb-2">
                        <Translate text={active?.title || staticDining.title} />
                    </h1>
                    <p className="font-body text-sm text-primary-foreground/70 max-w-sm">
                        {t('dining.viewFort', 'Dine with the fort in sight')}
                    </p>
                </motion.div>
            </div>
            ...
            <section className="section-padding max-w-7xl mx-auto" ref={ref}>
                <div className="text-center mb-14">
                    <p className="font-body text-xs tracking-[0.3em] uppercase text-accent mb-4">{t('dining.experience', 'The Experience')}</p>
                    <h2 className="section-heading">{t('dining.heading', 'Our Dining Options')}</h2>
            ...
            <section className="section-padding bg-background border-t border-border">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-14">
                        <p className="font-body text-xs tracking-[0.3em] uppercase text-accent mb-4">{t('dining.gallery', 'Gallery')}</p>
                        <h2 className="section-heading">{t('dining.ambience', 'The Ambience')}</h2>
                        <div className="gold-divider mt-6" />
                    </div>
